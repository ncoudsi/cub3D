...
/*   Updated: 2020/10/01 14:20:06 by ncoudsi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_sprite_params_values(int sprite_index)
{
	...
	set_absolute_sprite_pos((t_vector *)sprite_pos((t_sprite *)sprite_tab_index(sprite_index)));
	...
	set_sprite_screen_x((int)((resolution_x() / 2) * (1 + transformed_pos_x() / transformed_pos_y())));
